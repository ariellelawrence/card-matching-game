...
function initGame() {
    ...
    shuffledCards.forEach((cardValue, index) => {
        ...
        if (cardValue === 1) {
            ...
            cardBackElement.classList.add('black-cat');
        } else if (cardValue === 2) {
            cardBackElement.classList.remove('card-back');
            cardBackElement.classList.add('orange-cat');
        } else if (cardValue === 3) {
            cardBackElement.classList.remove('card-back');
            cardBackElement.classList.add('tabby-cat');
        } else if (cardValue === 4) {
            cardBackElement.classList.remove('card-back');
            cardBackElement.classList.add('white-cat');
        } else if (cardValue === 5) {
            cardBackElement.classList.remove('card-back');
            cardBackElement.classList.add('gray-cat');
        } else if (cardValue === 6) {
            cardBackElement.classList.remove('card-back');
            cardBackElement.classList.add('calico-cat');
        }
