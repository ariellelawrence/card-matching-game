...
function initGame() {
    ...
    shuffledCards.forEach((cardValue, index) => {
        ...
        if (cardValue === 1) {
            ...
            cardBackElement.classList.add('debut');
        } else if (cardValue === 2) {
            cardBackElement.classList.remove('card-back');
            cardBackElement.classList.add('fearless');
        } else if (cardValue === 3) {
            cardBackElement.classList.remove('card-back');
            cardBackElement.classList.add('speak-now');
        } else if (cardValue === 4) {
            cardBackElement.classList.remove('card-back');
            cardBackElement.classList.add('red');
        } else if (cardValue === 5) {
            cardBackElement.classList.remove('card-back');
            cardBackElement.classList.add('nine');
        } else if (cardValue === 6) {
            cardBackElement.classList.remove('card-back');
            cardBackElement.classList.add('reputation');
        }
