...
function initGame() {
    ...
    shuffledCards.forEach((cardValue, index) => {
        ...
        if (cardValue === 1) {
            ...
            cardBackElement.classList.add('golden');
        } else if (cardValue === 2) {
            cardBackElement.classList.remove('card-back');
            cardBackElement.classList.add('poodle');
        } else if (cardValue === 3) {
            cardBackElement.classList.remove('card-back');
            cardBackElement.classList.add('german');
        } else if (cardValue === 4) {
            cardBackElement.classList.remove('card-back');
            cardBackElement.classList.add('chi');
        } else if (cardValue === 5) {
            cardBackElement.classList.remove('card-back');
            cardBackElement.classList.add('lab');
        } else if (cardValue === 6) {
            cardBackElement.classList.remove('card-back');
            cardBackElement.classList.add('rott');
        }
