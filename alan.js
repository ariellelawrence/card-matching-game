...
function initGame() {
    ...
    shuffledCards.forEach((cardValue, index) => {
        ...
        if (cardValue === 1) {
            ...
            cardBackElement.classList.add('alan-1');
        } else if (cardValue === 2) {
            cardBackElement.classList.remove('card-back');
            cardBackElement.classList.add('alan-2');
        } else if (cardValue === 3) {
            cardBackElement.classList.remove('card-back');
            cardBackElement.classList.add('alan-3');
        } else if (cardValue === 4) {
            cardBackElement.classList.remove('card-back');
            cardBackElement.classList.add('alan-4');
        } else if (cardValue === 5) {
            cardBackElement.classList.remove('card-back');
            cardBackElement.classList.add('alan-5');
        } else if (cardValue === 6) {
            cardBackElement.classList.remove('card-back');
            cardBackElement.classList.add('alan-6');
        }
